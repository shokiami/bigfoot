...
There are two different ways to interface with the program, with a input table, or by inputting the values.

To input the values, run the Main class with no parameters:
java Main
